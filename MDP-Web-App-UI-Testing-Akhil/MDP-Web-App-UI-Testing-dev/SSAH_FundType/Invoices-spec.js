var SSAH_Invoices = require('../SSAH_FundType/Invoices.po.js');
var Expenses_Page = require('../SSAH_FundType/Expenses.po.js');
...
describe('SSAH Invoices Test Cases', function () {
  ...
  it('Select all three fiscal year invoices and check the validation', function () {
